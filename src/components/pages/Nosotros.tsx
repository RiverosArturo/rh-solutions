...
import { fadeInUp, nosotrosTexto } from '@/utils';
                ...
                <div className="max-w-4xl mx-auto grid sm:grid-cols-2 gap-6">
                    {servicios.map(({ title, description, color }, i) => (
                        <motion.div
                            ...
                            className={`bg-gradient-to-br from-white/70 to-white/30 backdrop-blur-lg p-6 rounded-2xl shadow-md border border-gray-200 ${i === 2 ? 'sm:col-span-2' : ''
                                }`}
                        >
